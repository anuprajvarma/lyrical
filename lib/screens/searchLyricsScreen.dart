...
class SearchLyricScreen extends StatefulWidget {
  ...
  SearchLyricScreen({this.lyrics_name = ''});

  @override
  _SearchLyricScreen createState() =>
      _SearchLyricScreen(lyrics_name: lyrics_name);
}

class _SearchLyricScreen extends State<SearchLyricScreen> {
  ...
  _SearchLyricScreen({this.lyrics_name = ''});
